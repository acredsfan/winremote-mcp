...
TOOL_CATEGORIES: dict[str, ToolCategory] = {
    ...
    "KeyDown": ToolCategory.DESKTOP,
    "KeyUp": ToolCategory.DESKTOP,
    "HoldKeys": ToolCategory.DESKTOP,
    "MouseDown": ToolCategory.DESKTOP,
    "MouseUp": ToolCategory.DESKTOP,
    "MouseMoveRelative": ToolCategory.DESKTOP,
    "MouseLook": ToolCategory.DESKTOP,
    ...
    "ObserveScreen": ToolCategory.DESKTOP,
    "UIAct": ToolCategory.DESKTOP,
    "UISequence": ToolCategory.DESKTOP,
    "UIWatch": ToolCategory.DESKTOP,
    "LockScreen": ToolCategory.DESKTOP,
    "Wait": ToolCategory.DESKTOP,
    "WaitForRegionText": ToolCategory.DESKTOP,
    "WaitForImageChange": ToolCategory.DESKTOP,
    "CaptureFailureBundle": ToolCategory.DESKTOP,
    "RobloxStudioInspectUI": ToolCategory.DESKTOP,
    "RobloxStudioOpenTab": ToolCategory.DESKTOP,
    "RobloxStudioEnsurePanel": ToolCategory.DESKTOP,
    "RobloxStudioRunPlaytest": ToolCategory.DESKTOP,
    "RobloxStudioStopPlaytest": ToolCategory.DESKTOP,
    "RobloxStudioResetCharacter": ToolCategory.DESKTOP,
    "RobloxStudioTeleportToCheckpoint": ToolCategory.DESKTOP,
    "RobloxStudioRunNamedTest": ToolCategory.DESKTOP,
    # File operations
    ...
    "AssertWindowActive": ToolCategory.QUERY,
    "AssertProcessRunning": ToolCategory.QUERY,
    "RobloxStudioGetOutput": ToolCategory.QUERY,
    "RobloxStudioGetErrors": ToolCategory.QUERY,
    "RobloxStudioGetTestState": ToolCategory.QUERY,
    "ListTerminalSessions": ToolCategory.QUERY,
    "ReadTerminalOutput": ToolCategory.QUERY,
    "WaitForTerminalOutput": ToolCategory.QUERY,
    "GetActionBudgetStatus": ToolCategory.QUERY,
    "ConfigureActionBudget": ToolCategory.QUERY,
    "ResetActionBudget": ToolCategory.QUERY,
    "VSCodeListWindows": ToolCategory.QUERY,
    "VSCodeGetActiveFile": ToolCategory.QUERY,
    "VSCodeListOpenFiles": ToolCategory.QUERY,
    "VSCodeGetDiagnostics": ToolCategory.QUERY,
    "VSCodeReadProblemsPanel": ToolCategory.QUERY,
    "VSCodeReadTerminal": ToolCategory.QUERY,
    # Shell
    "Shell": ToolCategory.SHELL,
    "Scrape": ToolCategory.SHELL,
    "CreateTerminalSession": ToolCategory.SHELL,
    "SendTerminalInput": ToolCategory.SHELL,
    "StopTerminalSession": ToolCategory.SHELL,
    "VSCodeOpenFile": ToolCategory.SHELL,
    "VSCodeRunCommand": ToolCategory.SHELL,
    # Network
